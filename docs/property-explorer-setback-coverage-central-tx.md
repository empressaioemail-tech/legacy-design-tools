...
| `kyle-tx` | populated (10 districts incl. R-1/R-1-A/RS/M-2) | `lib/adapters/src/local/setbacks/kyle-tx.json`; eCode360 Chapter 53 §53-33 Charts 1–2. |
...
| `lockhart-tx` | populated (7 districts incl. RLD/RMD/RHD) | `lib/adapters/src/local/setbacks/lockhart-tx.json`; official [Ordinance 2024-18, Appendix II](https://mcclibraryfunctions-stage.azurewebsites.us/api/ordinanceDownload/11173/1309249/pdf). RMD/RHD development-type, central-business, PDD, and conditional-adjacency cases remain omitted. |
| `new-braunfels-tx` | populated | `lib/adapters/src/local/setbacks/new-braunfels-tx.json`; Chapter 144 ?144-3.4. |
| `pflugerville-tx` | populated (10 districts) | `lib/adapters/src/local/setbacks/pflugerville-tx.json`; City UDC ?4.2.4, Tables 4.2.4A-C at [Encode Plus](https://online.encodeplus.com/regs/pflugerville/doc-view.aspx?print=1&tocid=004.004). |
| `round-rock-tx` | populated | `lib/adapters/src/local/setbacks/round-rock-tx.json`; Code Chapter 2 ?2-26. |
| `san-antonio-tx` | populated (21 districts incl. C/O/I commercial-industrial) | `lib/adapters/src/local/setbacks/san-antonio-tx.json`; official [UDC Table 310-1](https://sanantonio-tx.elaws.us/code/udc_artiii_div2_sec35-310.01), with public [City table rendering](https://docsonline.sanantonio.gov/FileUploads/DSD/IB565.pdf). Remaining industrial/office/downtown, special, overlay, and lot-orientation/plat conditions remain omitted. |
| `san-marcos-tx` | populated (8 districts: SF-6/SF-4.5 + legacy MU/CC/GC/P/NC/OP) | `lib/adapters/src/local/setbacks/san-marcos-tx.json`; 2025 Dev Code Ch.4 SF + Ch.9 §9.1.1.1 legacy. |
