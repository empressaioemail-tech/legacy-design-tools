...
(function(){
  ...
  function render(){
    ...
    if(model.kind==="board"){
      ...
      root.innerHTML='<div class="card"><div class="hdr"><span class="mark"></span>Smart Site · waiting <span data-script="ran">script-ran</span></div><p class="empty">Waiting for a screen or a parcel.</p></div>';
    }
  }
