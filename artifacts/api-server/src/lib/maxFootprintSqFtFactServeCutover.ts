 ...
 * maxFootprintSqFt has none -- and resolves to `notCutOverMaxFootprintSqFtFact`.
 * The slate decision for this rail is held by parcelRecordAllowlist.ts and is
 * executable at this call site.
 *
