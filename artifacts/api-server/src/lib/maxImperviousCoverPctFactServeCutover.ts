 ...
 * maxImperviousCoverPct has none. It resolves to
 * `notCutOverMaxImperviousCoverPctFact`. Travis (48453) / Austin scope ONLY:
 * the writer refuses every other county (COUNTY_NOT_IN_SCOPE).
 *
