...
describe("BriefingRecentRunsPanel — prior-narrative polish (Task #303 B.3/B.4/B.5)", () => {
  ...
  // the copy landed.
  it("B.4 — surfaces a 'Couldn't copy' indicator (not 'Copied!') when navigator.clipboard is unavailable", async () => {
    seedPriorRow({
      priorSectionA: "Prior A body.",
      currentSectionA: "Current A body.",
    });
  ...
  // plan-review test pins the same testid + timing so a future
  // shared-lib lift stays a no-op.
  it("B.4 — surfaces the 'Couldn't copy' indicator when navigator.clipboard.writeText rejects", async () => {
    seedPriorRow({
      priorSectionA: "Prior A body.",
      currentSectionA: "Current A body.",
    });
