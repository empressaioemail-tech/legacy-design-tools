...
/**
 * SubmitToJurisdictionDialog (plan-review) — Task #88.
 *
 * Mirror of `design-tools/src/components/SubmitToJurisdictionDialog.tsx`
 * so Plan Review users can record a package submission without
 * bouncing to the design-tools artifact. Both copies are intentional
 * because artifacts in this monorepo never import each other; they
 * share the generated API hooks and zod constants instead. Keep the
 * two surfaces in sync when iterating on the submit flow.
 */
