...
export const SUBMITTALS: Submittal[] = [
  ...
  { id: "SUB-2026-0153", projectName: "El Camino Real Mixed-Use", Hwy: "Hwy 71, Bastrop, TX", firm: "Commercial Dev", firmInitials: "CD", submittedAt: "2026-04-02T14:50:00Z", disciplines: ["architectural", "zoning", "civil", "mep"], status: "approved", aiFindingsCount: 6, blockingCount: 0, reviewProgress: 100 }
];
...
export const FINDINGS: Finding[] = [
  ...
  { id: "F-L1.01-018", submittalId: "SUB-2026-0150", discipline: "landscape", severity: "info", source: "ai-reviewer", title: "Irrigation controller", location: "Location of irrigation controller not indicated on plan.", codeRef: "UDC §6.8.2", edition: "Bastrop UDC", identifiedAt: "2026-04-13T11:00:00Z", status: "open" }
];
