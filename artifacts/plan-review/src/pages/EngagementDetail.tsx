 ...
 * #103). Reviewer comments are capped at 4 KB by the API contract
 * and a long correction list could otherwise dominate the past-
 * submissions list and push other rows off-screen.
 *
