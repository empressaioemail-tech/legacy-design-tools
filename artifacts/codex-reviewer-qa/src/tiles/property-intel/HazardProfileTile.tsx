...
export default function HazardProfileTile() {
  ...
  async function handleRun() {
    ...
    setQuotaBanner(null);
    try {
      await runReport(engagementId, "hazard");
      const report = await getReport(engagementId, "hazard");
      ...
      const payload = report.result as {
